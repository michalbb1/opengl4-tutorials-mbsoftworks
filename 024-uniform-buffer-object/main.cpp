...
int main()
{
	const std::string& windowTitle = "024.) Uniform Buffer Object - Tutorial by Michal Bubnar (www.mbsoftworks.sk)";
	...
	opengl4_mbsoftworks::tutorial024::OpenGLWindow024 window;
