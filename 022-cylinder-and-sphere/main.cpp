...
int main()
{
	const std::string& windowTitle = "022.) Cylinder And Sphere - Tutorial by Michal Bubnar (www.mbsoftworks.sk)";
	...
	opengl4_mbsoftworks::tutorial022::OpenGLWindow022 window;
