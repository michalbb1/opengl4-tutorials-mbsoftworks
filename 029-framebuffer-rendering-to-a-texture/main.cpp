...
int main()
{
	const std::string& windowTitle = "029.) Framebuffer Rendering to a Texture - Tutorial by Michal Bubnar (www.mbsoftworks.sk)";
	...
	opengl4_mbsoftworks::tutorial029::OpenGLWindow029 window;
