...
// Project
#include "015-geometry-shaders.h"
...
int main()
{
	const std::string& windowTitle = "015.) Geometry Shaders - Tutorial by Michal Bubnar (www.mbsoftworks.sk)";
	...
	opengl4_mbsoftworks::tutorial015::OpenGLWindow015 window;
