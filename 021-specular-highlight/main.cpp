...
int main()
{
	const std::string& windowTitle = "021.) Specular Highlight - Tutorial by Michal Bubnar (www.mbsoftworks.sk)";
	...
	opengl4_mbsoftworks::tutorial021::OpenGLWindow021 window;
