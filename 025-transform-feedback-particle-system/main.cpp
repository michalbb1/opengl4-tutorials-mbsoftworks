...
int main()
{
    const std::string& windowTitle = "025.) Transform Feedback Particle System - Tutorial by Michal Bubnar (www.mbsoftworks.sk)";
    ...
    opengl4_mbsoftworks::tutorial025::OpenGLWindow025 window;
