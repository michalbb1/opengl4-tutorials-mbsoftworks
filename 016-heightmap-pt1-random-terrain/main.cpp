...
int main()
{
	const std::string& windowTitle = "016.) Heightmap Pt.1 - Random Terrain - Tutorial by Michal Bubnar (www.mbsoftworks.sk)";
	...
	opengl4_mbsoftworks::tutorial016::OpenGLWindow016 window;
